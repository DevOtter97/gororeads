  ...
  return (
    <div class="filters-container">
      ...
      <div class="filters-row">
        ...
        <button
          class={`btn btn-sm favorites-toggle ${showFavoritesOnly ? 'active' : ''}`}
          onClick={onFavoritesToggle}
          title={showFavoritesOnly ? 'Mostrar todos' : 'Solo favoritos'}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill={showFavoritesOnly ? 'currentColor' : 'none'} stroke="currentColor" stroke-width="2">
